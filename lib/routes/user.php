            ...
            <div class="row gx-3">
                <div class="col-md-4 ">
                    <div class="p-3 social-info">
                        ...
                        <div class="body">
                            <span style="color:#3b5998;"><i class="fab fa-facebook"></i> Facebook </span> <a href="<?php view_facebook(); ?>"><?php view_username(); ?>.facebook</a><br>
                            <span style="color:#25D366;"><i class="fab fa-whatsapp"></i> Whatsapp </span>  <a href="<?php view_whats(); ?>"><?php view_username(); ?>.facebook</a><br>
